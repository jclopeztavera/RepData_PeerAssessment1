...
Looking at the dataset, we can notice a couple of major oddities, which should be solved by cleaning the dataset: 
...
storm_data <- storm_data %>%
  ...
  select(-c(contains(match = "dmg", ignore.case = TRUE)))
